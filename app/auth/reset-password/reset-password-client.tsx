    ...
    return (
      <AuthCard title="Invalid link">
        ...
        <Link
          ...
          className="block w-full text-white font-bold py-3 rounded-xl text-center hover:opacity-90 transition-all text-sm"
    ...
    <AuthCard title="Set a new password" subtitle="Choose a strong password you haven't used before.">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full text-white font-bold py-3 rounded-xl hover:opacity-90 transition-all disabled:opacity-50"
          style={{ background: 'linear-gradient(135deg,#20D3B3,#3B82F6,#8B5CF6)' }}
        >
